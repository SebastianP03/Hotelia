...
<!-- Mirrored from radixtouch.in/templates/admin/hotel/source/calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jan 2020 12:40:16 GMT -->
<head>
	<meta charset="utf-8" />
				...
				<div class="page-content">
						...
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="../../index.php">Pàgina principal</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="dashboard.php">Inicio</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Eventos arrastrables</header>
								</div>
								<div class="card-body ">
									<div id="external-events">
										<form class="inline-form">
											<input type="text" value="" class="form-control"
												placeholder="Nombre del evento..." id="event_title" />
											<br />
											<a href="javascript:;" id="event_add" class="btn deepPink-bgcolor"> Agregar Evento</a>
										</form>
										<hr />
										<div id="event_box" class="mg-bottom-10"></div>
										<label class="rt-chkbox rt-chkbox-single rt-chkbox-outline" for="drop-remove">
											Quitar despues del dia
...
<!-- Mirrored from radixtouch.in/templates/admin/hotel/source/calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jan 2020 12:40:26 GMT -->
</html>