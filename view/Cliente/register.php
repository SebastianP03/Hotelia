...
<div class="container">
      <div class="row">
       	  <section class="col-md-6 col-md-offset-3 text-center">
                 ...
                 <h2 class="title "><img src="../../assets/images/logo2.png" alt=""></h2>
                <h3 class="tiles-title text-center"> Registrate <strong class="text-blue">gratis</strong></h3>
                  <form action="../../controller/clienteController.php" method="post" class="form-group">
                      <div class="input col-sm-12">
                          <input type="email" class="icon-a icon-a-mail" name="email" placeholder="Email" />
                      </div>
                      <div class="input col-sm-6">
                          <input type="text" class="icon-a icon-a-user" name="name" placeholder="Nombre" />
                      </div>
                      <div class="input col-sm-6">
                          <input type="text" class="icon-a icon-a-user" name="lastname" placeholder="Apellidos" />
                      </div>
                     
                      <div class="input col-sm-6">
                          <input type="date" name="birth" class="icon-a icon-a-user"/>
                      </div>
                      <div class="input col-sm-6">
                          <input type="tel" name="tel" class="icon-a icon-a-user" placeholder="Numero de telefono" />
                      </div>
        ...
        ?>
                    ...
                    <div class="btn-block bold clearfix text-center">
                       	  <p><input type="checkbox"/> Acepto la <a href="#">Política de Privacidad y Condiciones de Uso</a> </p>
                          <button class="btn btn-info" name="btn" value="registrar">Resgistrarse <i class="glyphicon glyphicon-circle-arrow-right"></i> </button>    
                   	  </div>
                  </form>
             </div>
          </section>
