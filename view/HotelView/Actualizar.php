                            ...
                            <input type="hidden" name="IdHot" value="<?php echo $Hot['Id_Hotel']?>"><br>
                                <div class="row">
                                    <div class="input col-sm-6">
                                        <label>Nombre :</label>
                                        <input type="text" class="icon-a icon-a-user" name="NomHot" value="<?php echo $Hot['Nombre_Hotel']?>">
                                    </div>
                                    <div class="input col-sm-6">
                                      <label>Dirección :</label>
                                      <input type="text" class="icon-a icon-a-user" name="DirHot" value="<?php echo $Hot['Direccion_Hotel']?>">
                                  </div>
                                </div>
                                ...
                                <div class="row">
                                  	<div class="input col-sm-6">
                                        ...
                                        <input type="text" name="DesHot" value="<?php echo $Hot['Descripcion_Hotel']?>">
                                    </div>
                                     <div class="input col-sm-6">
                                        <label>imagen :</label>
                                        <input type="text" name="ImaHot" value="<?php echo '<img src="data:image/jpg;base64,'.base64_encode( $Hot['Imagen_Hotel'] ).'"/>'; ?>">
                                    </div>
                                </div>
                                ...
                                <button class="btn btn-info" name="AccionB" value="Actualizar">Actualizar hotel</button>    
