									...
									<div class="profile-tab-box">
										<div class="p-l-20">
                                            ...
                                            <li class="nav-item tab-all"><a class="nav-link active show"
														href="#tab1" data-toggle="tab">Hotel</a></li>
											</ul>
										</div>
									</div>
									<div class="white-box">
													...
													<div class="col-md-12 col-sm-12">
														...
														<div class="card-body " id="bar-parent1">
															...
															<div class="col-md-6 col-sm-6"> 
                                                                ...
                                                                <label>Nombre</label>
                                                                    <input type="text" class="form-control" name="NomHot" required>
																</div>
																<div class="form-group">
                                                                <label>Dirección</label>
                                                                    <input type="text" class="form-control" name="DirHot" required>
                                                            	</div>
																<div class="form-group">
																	<label>Descripción</label>
																	<input type="text" class="form-control" name="DesHot" required>
																</div>
																<div class="form-group">
																	<label>Imagen</label><br>
																	<input type="file" name="ImaHot" required>
																</div>
																<div class="form-group">
																	<label>Estado</label>
																	<select name="EstHot">
                                                                ...
                                                                <input type="hidden" value="<?php echo $_SESSION['ID']?>" name="IdEnc">
															</div>
																<button type="submit" class="btn btn-primary" name="AccionB" value="Registrar">Registrar</button>
                                                                </form>
														</div>
