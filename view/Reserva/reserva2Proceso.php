...
<html lang="es">
    ...
    <div class="main-wrap">
      <header class="mini-header">
         ...
         <header class="main-header" id="header">
            ...
            <div class="container">
                ...
                <section class="row step-content">
                	<div class="col-md-8">
                      	<section class="search-result m-t-30">
							<div class="list-result no-border" style="height:510px">
                                    <div class="head">
                                        <div class="col-sm-11">
                                            <em>No.Ticket</em> 2432238094 
                                            <em>| Fri, 03 Sep 2021 | Hotel Bogotá</em>
                                        </div>
                                    </div>
                                    <div class="row">
                                    	<h3 class="tiles-title text-center bold">Procesando el pago</h3>    
                                        <span class="plane-loader"></span>
                                        <p class="col-sm-10 col-sm-offset-1 text-center">
                                        	Se esta procesando el pago para su reserva
                                            <br />
                                            Si la pagina no avanza <strong>recarguela.</strong>
                                        </p>
                                        <div class="p-t-20 col-sm-10 col-sm-offset-1">
                                            <div class="timer">
                                               Hotel Bogota
                                                <strong>Realizando la reserva</strong>
                                                <span>Fri, 03 Sep 2021 | Sun, 05 Sep 2021</span>
                                            </div>
                                            <p class="bold p-t-10 p-l-20 p-r-20 p-b-10 text-center">Se le notificara en el correo al realizar la reserva. <br /> Si la informacion es erronea corrija sus datos.</p>
                                        </div>
                                	</div>
                            </div>
                      </section>
        ...
        <script src="../../assets/js/procesando.js"></script>
