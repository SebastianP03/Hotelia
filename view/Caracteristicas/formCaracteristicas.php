				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Registrar una caracteristica</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="index.html">Menú Principal</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Registar caracteristica</li>
							</ol>
						</div>
					</div>
					<div class="row">
									...
									<div class="profile-tab-box">
										<div class="p-l-20">
                                            ...
                                            <li class="nav-item tab-all"><a class="nav-link active show"
														href="#tab1" data-toggle="tab">carcateristicas</a></li>
											</ul>
										</div>
									</div>
									<div class="white-box">
											...
											<div class="tab-pane" id="tab3">
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="card-head">
															<header>Información de carcateristicas</header>
														</div>
...
<br> <input type="text" class="form-control" name="AirCar" required placeholder="Aire Acondicionado "/>   
</div> 

<div class="form-group">
 <label for="Television_Caracteristicas"><b>Television</b> </label>
<br> <input type="text" class="form-control" name="TelCar" required placeholder="television "/>   
</div> 

 <div class="form-group">
 <label for="Tipo_Cama_Caracteristicas"><b>caracteristicas tipo de cama</b> </label>
<br> <input type="text" class="form-control" name="TipCar" required placeholder="Tipo de cama"/>   
</div>    

<input type="submit" name="AccionC" class="btn btn-primary" value="Registrar">
