...
$Caracteristicas=$ModeloCaracteristicas;
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="../HotelView/apartadoHotel.php" class="nav-link ">
											...
											<span class="title">Informacion de Servicios</span>
										</a>
									</li>
									<li class="nav-item">
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<div class=" pull-left">
								<div class="page-title">Actualizar caracteristicas</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="index.html">Menú Principal</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Registar Caracteristicas</li></a>&nbsp;<i class="fa fa-angle-right"></i>
                                                                <li class="active">Actualizar Caracteristicas</li>
							</ol>
						</div>
					</div>
					<div class="row">
						...
						href="#tab1" data-toggle="tab">Caracteristicas</a></li>
											</ul>
										</div>
									</div>
									<div class="white-box">
											...
											<div class="tab-pane" id="tab3">
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="card-head">
															<header>Información de Caracteristicas</header>
														</div>
   ...
   <?php
        $Caracteristicas=$ModeloCaracteristicas->listar();
    ...
    <form action="../../controller/caracteristicasController.php" method="POST">
    ...
    <label for="Id_Caracteristicas"><b>Id</b> </label>
    <br> <input type="text" class="form-control" name="IdCar" readonly value="<?php echo $Car['Id_Caracteristicas']?>"><br>
    </div> 

    <div class="col-md-8">
    <label for="Aire_Acondicionado_Caracteristicas"><b>Aire Acondicionado</b></label>
    <br> <input type="text" class="form-control" name="AirCar" required placeholder="Aire acondicionado" value="<?php echo $Car['Aire_Acondicionado_Caracteristicas']?>"><br>
    </div> 
     
    <div class="col-md-8">
    <label for="Television_Caracteristicas"><b>Television</b> </label>
    <br> <input type="text" class="form-control" name="TelCar" required placeholder="Television" value="<?php echo $Car['Television_Caracteristicas']?>"><br>
    </div> 

    <div class="col-md-8">
    <label for="Tipo_Cama_Caracteristicas"><b>Tipo de Cama </b></label>
    <br> <input type="text" class="form-control" name="TipCar" required placeholder="Tipo de cama" value="<?php echo $Car['Tipo_Cama_Caracteristicas']?>"><br>
    </div> 


    <input type="submit" name="AccionC" class="btn btn-primary" value="Actualizar">
