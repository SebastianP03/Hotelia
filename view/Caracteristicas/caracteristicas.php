...
<body
    ...
    <div class="page-wrapper">
                        ...
                        <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true"
                            ...
                            <li class="sidebar-user-panel">
								<div class="user-panel">
									...
									<div class="profile-usertitle">
										...
										<div class="profile-usertitle-job"> Caractereristicas </div>
									</div>
							...
							<li class="nav-item">
								<a href="#" class="nav-link nav-toggle">
									...
									<span class="title">Mis Caracteristicas</span>
									<span class="arrow"></span>
								</a>
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="../HotelView/apartadoHotel.php" class="nav-link ">
											...
											<span class="title">Informacion Caracteristicas</span>
										</a>
									</li>
									<li class="nav-item">
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Mis Caracteristicas</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Informacion caracteristicas</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20">
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <a href="formCaracteristicas.php">
                                                    <button id="addRow1" class="btn btn-info">
                                                        Registrar Nueva Caracteristica <i class="fa fa-plus"></i>
                                                    </button>
                                                </a>
                                            </div>
                                        </div>
      ...
      $Caracteristicas=$ModeloCaracteristicas->listar();
        ...
        ?>
            <td><?php echo $Car['Id_Caracteristicas']?></td>
            <td><?php echo $Car['Aire_Acondicionado_Caracteristicas']?></td>
            <td><?php echo $Car['Television_Caracteristicas']?></td>
            <td><?php echo $Car['Tipo_Cama_Caracteristicas']?></td>

             <th><a href="ActualizarCar.php?id=<?php echo $Car['Id_Caracteristicas'] ?>" class="btn btn-primary">Editar</th>  
             <th><a href=" InactivarCar.php?id=<?php echo $Car['Id_Caracteristicas'] ?>"><button type='button' class="btn btn-info" onclick="return ConfirmDelete()">Eliminar</buttom>                                                                
            </tr>
        </tr>
