				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Registrar Servicio</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="index.html">Menú Principal</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Registar Servicio</li>
							</ol>
						</div>
					</div>
					<div class="row">
...
<br>  <div class="col-md-8">
           ...
           <div class="form-group">    
            <b><label for="Nombre_Servicio" class="form-label"><b>Nombre</b></label></b>
             <br> <input type="text" class="form-control" name="NomSer" required placeholder="Nombre de servicio ">
          </div><br>
          
    <input type="submit"  class="btn btn-primary" name="AccionS"  value="Registrar">
														</div>
