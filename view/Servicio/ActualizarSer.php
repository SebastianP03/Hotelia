...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Registar Servicio</li></a>&nbsp;<i class="fa fa-angle-right"></i>
									...
									<div class="profile-tab-box">
										<div class="p-l-20">
                                            ...
                                            <li class="nav-item tab-all"><a class="nav-link active show"
														href="#tab1" data-toggle="tab">Servicios</a></li>
											</ul>
										</div>
									</div>
									<div class="white-box">
											...
											<div class="tab-pane" id="tab3">
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="card-head">
															<header>Información de los Servicios</header>
														</div>
														<div class="card-body " id="bar-parent1">
                                        
                                                    

    <!--<a href="../Servicio/servicio.php"><button class="btn btn-primary">Volver</button></a><br><br>-->
    ...
    <br> <input type="text" class="form-control"  readonly name="IdSer"  value="<?php echo $Ser['Id_Servicio']?>"><br>
    </div> 

    <div class="form-group">
    <label for="Nombre_Servicio">Nombre Servicio </label>
    <br> <input type="text" class="form-control" name="NomSer" required placeholder="Nombre servicio" value="<?php echo $Ser['Nombre_Servicio']?>"><br>
    </div> 


    <input type="submit" name="AccionS" class="btn btn-primary" value="Actualizar">
