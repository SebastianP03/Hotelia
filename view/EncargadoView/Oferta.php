						...
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="../EncargadoView/indexEncargado.php">Menú Principal</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Realizar oferta</li>
							</ol>
						</div>
					</div>
					<div class="row">
												...
												<div class="row">
													<div class="col-md-12 col-sm-12">
														...
														<div class="card-body " id="bar-parent1">
                                                            ...
                                                            <form action="../../controller/EncargadoController.php" method="POST">
                                                                <?php
                                                                    $oferta= $ModeloEncargado->infoHabitacionOferta($IdHab);
                                                                    if ($oferta!=null) {
															...
															<div class="col-md-6 col-sm-6"> 
                                                                ...
                                                                <label>Cantidad Camas</label>
                                                                    <input type="text" class="form-control" value="<?php echo $ofe['CantidadCamas_Habitacion']?>" readonly>
																</div>
																<div class="form-group">
                                                                <label>Descripción</label>
                                                                    <input type="text" class="form-control" value="<?php echo $ofe['Descripcion_Habitacion']?>"  readonly>
                                                            	</div>
																<div class="form-group">
																	<label>Costo</label>
																	<input type="text" class="form-control" name="CosHab" value="<?php echo $ofe['Costo_Habitacion']?>">
																</div>
                                                                <input type="hidden" value="<?php echo $IdHab?>" name="IdHab">
															</div>
																<button type="submit" class="btn btn-primary" name="AccionB" value="Oferta">Oferta</button>
                                                                <?php }} ?>
                                                                </form>
														</div>
