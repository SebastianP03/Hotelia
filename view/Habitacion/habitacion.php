...
<body
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Mis Habitaciones</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Informacion de mi Habitacion</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20">
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <a href="formHabitacion.php?id=<?php echo $IdHotel?>">
                                                    <button id="addRow1" class="btn btn-info">
                                                        Registrar Nueva Habitacion <i class="fa fa-plus"></i>
                                                    </button>
                                                </a>
                                            </div>
                                        </div>
  ...
  <tbody>
          <tr>
          <?php
        $Habitacion=$ModeloHabitacion->listar($IdHotel);
    ...
    ?>
           ...
           <td><center> <img  width="100px" height="100px" src="data:image/png;base64,<?php echo base64_encode( $Hab['Imagen_Habitacion']);?>"/></center></td>
            ...
            <th><a href="Actualizar.php?id=<?php echo $Hab['Id_Habitacion'] ?>" class="btn btn-primary">Editar</th> 
          
             <th><a href="EliminarHab.php?id=<?php echo $Hab['Id_Habitacion'] ?>" class="btn btn-info">Inactivar</th>                                         
            </tr>
