$(document).ready(function() {
    example = $('#example').DataTable({
        "columnDefs":[{
           "targets": -1,
           "data": null,
           "defaultContent": "<div class='text-center'><div class='btn-group'><button class='btn btn-primary btnConsultar'><i class='far fa-file'></i></button><button class='btn btn-warning btnEditar'><i class='far fa-edit'></i></button><button class='btn btn-danger btnEliminar'><i class='far fa-trash-alt'></i></button></div></div>"
        }],
        "language":{
...
$(document).on("click", ".btnEditar", function(){
    ...
    fechaReserva = fila.find('td:eq(1)').text();
